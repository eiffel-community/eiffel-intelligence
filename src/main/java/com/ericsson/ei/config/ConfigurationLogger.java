...
public class ConfigurationLogger {
    ...
    private void logConfiguration() {
        LOGGER.debug("EI Backend started with following configurations:\n"
                ...
                + "missedNotificationCollectionName: " + environment.getProperty("missedNotificationCollectionName") + "\n"
                + "missedNotificationDataBaseName: " + environment.getProperty("missedNotificationDataBaseName") + "\n"
