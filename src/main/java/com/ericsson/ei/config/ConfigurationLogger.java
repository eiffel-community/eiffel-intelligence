...
public class ConfigurationLogger {
    ...
    private void logConfiguration() {
        LOGGER.debug("EI Backend started with following configurations:\n"
                ...
                + "event-handler.threads.corePoolSize: " + env.getProperty("event-handler.threads.corePoolSize") + "\n"
                + "event-handler.threads.queueCapacity: " + env.getProperty("event-handler.threads.queueCapacity") + "\n"
                + "event-handler.threads.maxPoolSize: " + env.getProperty("event-handler.threads.maxPoolSize") + "\n"
