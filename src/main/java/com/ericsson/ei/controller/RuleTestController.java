...
/**
 * This class is used for anything rule test related. It's currently used to test rules on Eiffel events. Test rules must be enabled in Eiffel Intelligence for the /rule-check endpoints to work.
