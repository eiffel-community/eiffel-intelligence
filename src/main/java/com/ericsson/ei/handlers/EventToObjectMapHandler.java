...
/**
 * @author evasiba Class for handling event to object map. The map has the event
 *         id as key and the value is a list with all the ids of objects that an
 *         event has contributed to.
 *
 */
@Component
public class EventToObjectMapHandler {
	...
	/**
	 * The method is responsible for the delete the EventObjectMap by using the
