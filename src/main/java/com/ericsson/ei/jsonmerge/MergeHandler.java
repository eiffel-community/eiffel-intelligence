...
public class MergeHandler {
	...
	/**
	 * The merge rule can contain a placeholder for the ids extracted from
	 * IdentifyRules. This placeholder need to be replaced with an id from the ones
	 * extracted with IdentifyRules before we use it in JMESPath. The placeholder is
	 * defined in application.properties as 'rules.replacement.marker'.
	 *
	 * @param rule string
