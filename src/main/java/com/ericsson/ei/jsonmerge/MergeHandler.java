...
public class MergeHandler {
    ...
    private void updateJsonObject(JSONObject aggregatedJsonObject, JSONObject preparedJsonObject) {
        try {
            Iterator<String> preparedJsonKeys =
                preparedJsonObject != null ? preparedJsonObject.keys() : new JSONObject().keys();
            ...
            while (preparedJsonKeys.hasNext()) {
                ...
                if (aggregatedJsonObject.has(preparedJsonKey)) {
                    ...
                    if (valueClass.equals(JSONObject.class)) {
                        final JSONObject o1 = getAsT(aggregatedJsonObject, preparedJsonKey, JSONObject.class);
                        final JSONObject o2 = getAsT(preparedJsonObject, preparedJsonKey, JSONObject.class);
                        updateJsonObject(o1, o2);
                    } else if (valueClass.equals(JSONArray.class)) {
                        final JSONArray a1 = getAsT(aggregatedJsonObject, preparedJsonKey, JSONArray.class);
                        final JSONArray a2 = getAsT(preparedJsonObject, preparedJsonKey, JSONArray.class);
