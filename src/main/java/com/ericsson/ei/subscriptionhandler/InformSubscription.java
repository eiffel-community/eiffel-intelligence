...
public class InformSubscription {
    ...
    /**
     * This method reformats notificationMeta and fetches values if applicable for
    ...
    private MultiValueMap<String, String> mapNotificationMessage(String aggregatedObject, JsonNode subscriptionJson) {
        ...
        if (subscriptionJson.has("authenticationType")) {
            ...
            if (authType.equals("BASIC_AUTH")) {
                boolean userNameFieldExists = subscriptionJson.has("userName");
                boolean passwordFieldExists = subscriptionJson.has("password");
