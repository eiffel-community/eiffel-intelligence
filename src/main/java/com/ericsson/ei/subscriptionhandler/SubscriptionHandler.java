...
public class SubscriptionHandler {
    ...
    private JsonNode requirement;
    String aggregatedObject;
     ...
     */
    public void checkSubscriptionForObject(String aggregatedObject) {
    ...
    public void extractConditions(String aggregatedObject, String subscriptionData) {
        ...
        if (checkRequirementType(requirementIterator, aggregatedObject)) {
            if (runSubscription.runSubscriptionOnObject(aggregatedObject, requirement, subscriptionJson)) {
     ...
     * @return boolean
     */
    public boolean checkRequirementType(Iterator<JsonNode> requirementIterator, String aggregatedObject) {
        requirement = null;
        JsonNode aggregatedJson = null;
