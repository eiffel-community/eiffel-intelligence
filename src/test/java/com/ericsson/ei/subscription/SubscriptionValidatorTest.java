...
public class SubscriptionValidatorTest {
	...
	/*
	 * Validator unit tests for  Repeat parameter in Subscription.
	 * Valid "repeat" value: true or false
	 */
	@Test
	public void validateRepeatValidRepeatTrueTest() {
		Boolean repeat = true;
		try {
			subscriptionValidator.validateRepeat(repeat);
		}
		catch (SubscriptionValidationException e) {
			assertTrue(e.getMessage(), false);
			return;
	...
	@Test
	public void validateRepeatValidRepeatFalseTest() {
