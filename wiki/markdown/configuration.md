...
How and examples of how to encrypt passwords can be found on Jasypt homepage, and by using the encrypt.sh script which can be downloaded from jasypt homepage:
