...
returns empty. Event is added to the waitlist. There it waits until the object
...
the database. aggregatedObject returns empty and event is added to the waitlist.
