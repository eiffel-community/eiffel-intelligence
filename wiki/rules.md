...
then it will wait a certain time as defined by property _waitlist.collection.ttlValue_ 
in [application's properties](../src/main/resources/application.properties)
